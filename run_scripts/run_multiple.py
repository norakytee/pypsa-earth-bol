...
#Define paths
#home = "C:/Users/marih/OneDrive/Documents/pypsa-2802/pypsa-earth/"
#master = "C:/Users/marih/OneDrive/Documents/5. Året/Masteroppgave/"
 
 
p_network = pypsa.Network("networks/elec_s_all_ec_lcopt_Co2L-1H.nc")
 
# Load the Excel file with line capacity data
lines_cap_df = pd.read_excel("custom_files/lines_capacity.xlsx")
...
p_network.export_to_netcdf("networks/elec_s_all_ec_lcopt_Co2L-1H-changed_lines.nc")
...
def run_all_scen():
    ...
    for scen in scenarios:
        network = 'networks/elec_s_all_ec_lcopt_Co2L-1H-changed_lines.nc'
        n = pypsa.Network(network)
        n.export_to_netcdf('networks/elec_s_all_ec_lcopt_Co2L-1H.nc')
        if scen == "base":
