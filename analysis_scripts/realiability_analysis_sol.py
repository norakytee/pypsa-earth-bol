...
def load_matrices(iteration):
    ...
    df_lines = pd.read_csv(f'/mnt/beegfs/users/noraky/pypsa-earth/matrices/lines_matrix_{iteration}.csv')
    df_generators = pd.read_csv(f'/mnt/beegfs/users/noraky/pypsa-earth/matrices/generators_matrix_{iteration}.csv')
    df_storage_units = pd.read_csv(f'/mnt/beegfs/users/noraky/pypsa-earth/matrices/storage_units_matrix_{iteration}.csv')
...
tot_component_caused_ll_df.to_csv('/mnt/beegfs/users/noraky/pypsa-earth/csa_results/avg_component_caused_ll.csv', index=False)
tot_multiple_components_caused_ll_df.to_csv('/mnt/beegfs/users/noraky/pypsa-earth/csa_results/avg_multiple_components_caused_ll.csv', index=False)
...
component_caused_ll_df.to_csv('/mnt/beegfs/users/noraky/pypsa-earth/csa_results/component_caused_ll.csv', index=False)
