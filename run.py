...
for index, row in n.generators.iterrows():
    ...
    #     n.generators.at[index, 'p_max_pu'] = 0.72 #0.72 for the future
    if row['carrier'] == 'ror':
        n.generators.at[index, 'p_max_pu'] = 0.5
    # if row['carrier'] == 'geothermal':
    #     n.generators.at[index, 'p_max_pu'] = 0.9
...
start_year = 2024
start_value = 2104949 #2533122 #2728743
end_year = 2050
end_value = 0
...
def extend_hydro(n):
    n.add("Generator",
        '83-6 hydro', # name of the new storage unit
        bus = '83',
        carrier = 'ror',
        p_nom = 0,
    ...
    n.add("Generator",
        '83-7 hydro', # name of the new storage unit
        bus = '83',
        carrier = 'ror',
        p_nom = 0,
        marginal_cost = 0.0103746318,
